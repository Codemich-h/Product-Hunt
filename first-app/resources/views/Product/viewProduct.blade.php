        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 mt-0">
            ...
            <div class="h-56 w-full">
                <img class="mx-auto h-full dark:hidden"
                    src="{{ asset('/Storage/'.$viewData["product"]->getImage()) }}" alt="" />
            </div>
            <div class="pt-6">
                ...
                <div class="mt-4 flex items-center justify-between gap-4">
                    <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">{{ $viewData['product']->getPrice()}}</p>
                    <p class="text-1xl font-extrabold leading-tight text-gray-900 dark:text-white">{{ $viewData['product']->getDescription()}}</p>
